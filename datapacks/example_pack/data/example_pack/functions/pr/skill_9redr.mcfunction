...
tag @s remove skill9r_be2
tag @s remove skillr_be
...
execute if score @s pr matches 1 run clear @a[team=pr_red,scores={skill_9=405}] stone_hoe
execute if score @s pr matches 2 run clear @a[team=pr_red,scores={skill_9=405}] golden_sword
execute if score @s pr matches 3 run clear @a[team=pr_red,scores={skill_9=405}] diamond_axe
execute if score @s pr matches 4 run clear @a[team=pr_red,scores={skill_9=405}] iron_sword
execute if score @s pr matches 5 run clear @a[team=pr_red,scores={skill_9=405}] bow
execute if score @s pr matches 6 run clear @a[team=pr_red,scores={skill_9=405}] wooden_axe
execute if score @s pr matches 7 run clear @a[team=pr_red,scores={skill_9=405}] trident
execute if score @s pr matches 8 run clear @a[team=pr_red,scores={skill_9=405}] crossbow
execute if score @s pr matches 9 run clear @a[team=pr_red,scores={skill_9=405}] diamond
execute if score @s pr matches 10 run clear @a[team=pr_red,scores={skill_9=405}] bow
clear @a[team=pr_red,scores={skill_9=405}] shield